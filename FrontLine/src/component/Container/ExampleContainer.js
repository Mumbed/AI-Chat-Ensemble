...
function ChatGPTExample() {
  return (
    <ResponseBox aiName="Chat_GPT" mainTitle="연필은 일반적으로 나무 또는 그래파이트로 만들어진 필기 도구입니다.">
...
function GeminiExample() {
  return (
    <ResponseBox aiName="Gemini" mainTitle="연필은 종이와 같은 거친 표면에 글씨를 쓰거나 그림을 그리는 데 사용할 수 있는 필기 도구입니다.">
...
function CopliotExample() {
  return (
    <ResponseBox aiName="Copliot" mainTitle="연필은 우리가 처음 글자를 배우기 시작할 때부터 사용했던 필기구입니다.">
